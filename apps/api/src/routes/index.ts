...
import outstandingPaymentsRoutes from '../modules/outstanding-payments/outstanding-payments.routes.js';
import loasRoutes from '../modules/loas/loas.routes.js';
...
router.use('/outstanding-payments', outstandingPaymentsRoutes);
router.use('/loas', loasRoutes);
